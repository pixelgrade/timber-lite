...
}(jQuery, window)); /* jquery.nicescroll 3.6.0 InuYaksa*2014 MIT http://nicescroll.areaaperta.com */
(function (f) {
  ...
  var v = window.MutationObserver || window.WebKitMutationObserver || !1,
      ...
      d.cursorgrabvalue = c;d.hasmousecapture = "setCapture" in f;d.hasMutationObserver = !1 !== v;
      return F = d
      },
      R = function (k, c) {
      function h() {
...
function (e, n, t) {
  ...
  function i() {
    var e, n, t, r, i, s, a;
    for (var f in _) {
      if (e = [], n = _[f], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
  ...
  function l(e, t, r, o) {
    var i, s, l, u, p = "modernizr",
        c = a("div"),
        d = f();
    if (parseInt(r, 10)) for (; r--;) l = a("div"), l.id = o ? o[r] : p + (r + 1), c.appendChild(l);
  ...
  function p(e, n, t) {
    var r;
    for (var i in e) if (e[i] in n) return t === !1 ? e[i] : (r = n[e[i]], o(r, "function") ? u(r, t || n) : r);
    return !1
  }
  function c(e, n) {
    return !!~ ("" + e).indexOf(n)
  ...
  function v(e, n, r, i) {
    ...
    for (d = e.length, p = 0; d > p; p++) if (v = e[p], h = N.style[v], c(v, "-") && (v = s(v)), N.style[v] !== t) {
    ...
    function checkCart() {
      ...
      if ($cart) {
        ...
        if ($productCount.html() == '0') {
          ...
          if (shopURL) $cart.find('.cart-widget-label').attr('href', shopURL);
